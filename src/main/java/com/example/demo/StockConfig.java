    ...
    CommandLineRunner commandLineRunner(StockRepository stockRepository,
        ...
        return args -> {
            ...
            List<Stock> stocks = List.of(
                    new Stock("AAPL", "Apple Inc.", 247.99),
                    new Stock("GOOGL", "Alphabet Inc.", 298.79),
                    new Stock("MSFT", "Microsoft Corporation", 381.85),
                    new Stock("AMZN", "Amazon.com Inc.", 205.37),
                    new Stock("TSLA", "Tesla Inc.", 367.96),
                    new Stock("META", "Meta Platforms Inc.", 598.66),
                    new Stock("NVDA", "NVIDIA Corporation", 172.93),
                    new Stock("NFLX", "Netflix Inc.", 91.82),
                    new Stock("DIS", "Walt Disney Company", 99.51),
                    new Stock("PYPL", "PayPal Holdings Inc.", 44.01),
                    new Stock("ADBE", "Adobe Inc.", 248.15),
                    new Stock("INTC", "Intel Corporation", 43.65),
                    new Stock("CSCO", "Cisco Systems Inc.", 77.62),
                    new Stock("CMCSA", "Comcast Corporation", 29.02),
                    new Stock("PEP", "PepsiCo Inc.", 150.04),
                    new Stock("COST", "Costco Wholesale", 972.33),
                    new Stock("AVGO", "Broadcom Inc.", 310.51),
                    new Stock("TXN", "Texas Instruments", 187.42),
                    new Stock("QCOM", "Qualcomm Inc.", 129.90),
                    new Stock("TMUS", "T-Mobile US Inc.", 208.47),
                    new Stock("AMGN", "Amgen Inc.", 347.80),
